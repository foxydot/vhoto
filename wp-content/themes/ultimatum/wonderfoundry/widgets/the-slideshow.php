<?php
if(get_theme_option('general','ultimatum_slideshows')){
...
function form($instance) {
		...
		$result = $wpdb->get_results($sel,ARRAY_A);
		?>
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', THEME_ADMIN_LANG_DOMAIN); ?></label>
		<input id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" class="widefat" />
		</p>
		<p>
	 	<label for="<?php echo $this->get_field_id('slide'); ?>"><?php _e( 'Select Slide Source' ,THEME_ADMIN_LANG ); ?></label>
		...
		foreach($result as $f){
			?>
			<option value="<?php echo $f[id];?>" <?php selected($slide,$f[id]); ?>><?php echo $f[name];?></option>
			<?php 
			}
		echo '</optgroup>';
		?>
		...
		<p>
		<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e( 'Item Count:' ,THEME_ADMIN_LANG ); ?></label>
		<input size="5" type="text" value="<?php echo $number; ?>"  id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" />
		<?php _e('If slideshow source is content',THEME_ADMIN_LANG_DOMAIN);?>
		</p>
		<p>
		<label for="<?php echo $this->get_field_id('exlen'); ?>"><?php _e( 'Excerpt Length:' ,THEME_ADMIN_LANG ); ?></label>
		<input size="5" type="text" value="<?php echo $exlen; ?>"  id="<?php echo $this->get_field_id('exlen'); ?>" name="<?php echo $this->get_field_name('exlen'); ?>" />
		<?php _e('If slideshow source is content',THEME_ADMIN_LANG_DOMAIN);?>
		</p>
		<p>
      	<label for="<?php echo $this->get_field_id('Height'); ?>"><?php _e( 'Slide Height :' ,THEME_ADMIN_LANG ); ?></label>
      	<input size="5" type="text" value="<?php echo $Height; ?>"  id="<?php echo $this->get_field_id('Height'); ?>" name="<?php echo $this->get_field_name('Height'); ?>" />
      	</p>
     
      	<div class="slider-select-wrapper">
      		<label for="<?php echo $this->get_field_id('Slider'); ?>"><?php _e( 'Select a SlideShow Script :' ,THEME_ADMIN_LANG ); ?></label>
			<select name="<?php echo $this->get_field_name('Slider'); ?>" id="<?php echo $this->get_field_id('Slider'); ?>" onchange="slideOpts(this);">
				<option value="">Select a Slider</option>
				<option value="nivo" <?php selected($Slider,'nivo'); ?>>Nivo</option>
				<option value="anything" <?php selected($Slider,'anything'); ?>>Anything</option>
				<option value="slidedeck" <?php selected($Slider,'slidedeck'); ?>>slidedeck</option>
				<option value="s3" <?php selected($Slider,'s3'); ?>>S3 Slider</option>
				<option value="flex" <?php selected($Slider,'flex'); ?>>Flex Slider(responsive)</option>
				<option value="zaccordion" <?php selected($Slider,'zaccordion'); ?>>zAccordion</option>
			...
			<div class="slider_options">
				<div class="supersized options" style="<?php if($Slider!='supersized'){ echo 'display:none'; }?>">
					<p><label for="<?php echo $this->get_field_id('superTrans'); ?>"><?php _e( 'Slide Effect :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
						<label for="<?php echo $this->get_field_id('superType'); ?>"><?php _e( 'Type :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('superSpeed'); ?>"><?php _e( 'Animation Speed :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('superInterval'); ?>"><?php _e( 'Pause Time :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<h4><?php _e('Full Width Slider options',THEME_ADMIN_LANG_DOMAIN);?></h4>
					<p>
	      				<label for="<?php echo $this->get_field_id('superHeight'); ?>"><?php _e( 'Height:' ,THEME_ADMIN_LANG ); ?></label>
	      			...
	      			<p>
	      				<label for="<?php echo $this->get_field_id('superTop'); ?>"><?php _e( 'Space from Top in px:' ,THEME_ADMIN_LANG ); ?></label>
	      			...
	      			<p>
					<label for="<?php echo $this->get_field_id('superCaptions'); ?>"><?php _e( 'Show Captions :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
	      				<label for="<?php echo $this->get_field_id('superCaptionsColor'); ?>"><?php _e( 'Captions Background Color:' ,THEME_ADMIN_LANG ); ?></label>
	      			...
	      			<p>
	      				<label for="<?php echo $this->get_field_id('superCaptionsText'); ?>"><?php _e( 'Captions Text Color:' ,THEME_ADMIN_LANG ); ?></label>
	      			...
	      			<p>
					<label for="<?php echo $this->get_field_id('superControls'); ?>"><?php _e( 'Show Next & Prev :' ,THEME_ADMIN_LANG ); ?></label>
					<select id="<?php echo $this->get_field_id('superControls'); ?>" name="<?php echo $this->get_field_name('superControls'); ?>" >
	      			...
	      			<p>
					<label for="<?php echo $this->get_field_id('super_color'); ?>"><?php _e( 'Theme :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<div class="anything options" style="<?php if($Slider!='anything'){ echo 'display:none'; }?>">
					<h3>Anything Slider Options: </h3>
					<p>
					<label for="<?php echo $this->get_field_id('AnyBg'); ?>"><?php _e( 'BackGround Color :' ,THEME_ADMIN_LANG ); ?></label>
					<input id="<?php echo $this->get_field_id('AnyBg'); ?>" name="<?php echo $this->get_field_name('AnyBg'); ?>" type="text" value="<?php echo $AnyBg;?>"/>
					</p>
					<p>
					<label for="<?php echo $this->get_field_id('AnyType'); ?>"><?php _e( 'Slider Type :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyVideo'); ?>"><?php _e( 'Show Video Instead of Image :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<label for="<?php echo $this->get_field_id('AnyWidth'); ?>"><?php _e( 'Image Width in Slide :' ,THEME_ADMIN_LANG ); ?></label>
					<input type="text" value="<?php echo $AnyWidth; ?>"  id="<?php echo $this->get_field_id('AnyWidth'); ?>" name="<?php echo $this->get_field_name('AnyWidth'); ?>" /><br />
	      			<label for="<?php echo $this->get_field_id('AnyHeight'); ?>"><?php _e( 'Image Height in Slide :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyCaption'); ?>"><?php _e( 'Captions :' ,THEME_ADMIN_LANG ); ?><i><?php _e('for full ones',THEME_ADMIN_LANG_DOMAIN)?></i></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyAuto'); ?>"><?php _e( 'Auto Start Slideshow :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('Anydelay'); ?>"><?php _e( 'Delay between slides:' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyanimationTime'); ?>"><?php _e( 'Animation Time:' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyHover'); ?>"><?php _e( 'Pause On Hover :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyArrows'); ?>"><?php _e( 'Show Arrows :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyNavi'); ?>"><?php _e( 'Bottom Navigation :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyEasing'); ?>"><?php _e( 'Animation (easing) :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('AnyColor'); ?>"><?php _e( 'Theme :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<h3>Flex Slider Options</h3>
				<p>
					<label for="<?php echo $this->get_field_id('flexanimation'); ?>"><?php _e( 'Animation :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexslideDirection'); ?>"><?php _e( 'Slide Direction :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexslideshow'); ?>"><?php _e( 'Auto Start :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexslideshowSpeed'); ?>"><?php _e( 'Slide Speed :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexanimationDuration'); ?>"><?php _e( 'Animation Speed :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexdirectionNav'); ?>"><?php _e( 'Navigation :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexcontrolNav'); ?>"><?php _e( 'Control Navigation :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexkeyboardNav'); ?>"><?php _e( 'Keyboard Navigation :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexmousewheel'); ?>"><?php _e( 'Mouse Wheel :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexrandomize'); ?>"><?php _e( 'Random Slides :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexanimationLoop'); ?>"><?php _e( 'Loop Slides :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexpauseOnAction'); ?>"><?php _e( 'Pause on action :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('flexpauseOnHover'); ?>"><?php _e( 'Pause on hover :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<h3>S3 Slider Options</h3>
					<i>Captins width applise to left-right captions while height applying to top-bottom captions</i>
					<p>
					<label for="<?php echo $this->get_field_id('s3width'); ?>"><?php _e( 'Captions Width :' ,THEME_ADMIN_LANG ); ?></label>
					<input type="text" value="<?php echo $s3width; ?>"  id="<?php echo $this->get_field_id('s3width'); ?>" name="<?php echo $this->get_field_name('s3width'); ?>" />
					</p>
					<p>
	      			<label for="<?php echo $this->get_field_id('s3height'); ?>"><?php _e( 'Captions Height:' ,THEME_ADMIN_LANG ); ?></label>
	      			...
	      			<p>
					<label for="<?php echo $this->get_field_id('s3captions'); ?>"><?php _e( 'Captions :' ,THEME_ADMIN_LANG ); ?></label>
					<select id="<?php echo $this->get_field_id('s3captions'); ?>" name="<?php echo $this->get_field_name('s3captions'); ?>" >
						<option value="top" <?php selected($s3captions,'top'); ?> ><?php _e('top',THEME_ADMIN_LANG_DOMAIN);?></option>
						<option value="bottom" <?php selected($s3captions,'bottom'); ?> ><?php _e('bottom',THEME_ADMIN_LANG_DOMAIN);?></option>
						<option value="left" <?php selected($s3captions,'left'); ?> ><?php _e('left',THEME_ADMIN_LANG_DOMAIN);?></option>
						<option value="right" <?php selected($s3captions,'right'); ?> ><?php _e('right',THEME_ADMIN_LANG_DOMAIN);?></option>
					</select>
					</p>
					<p>
	      			<label for="<?php echo $this->get_field_id('s3timeout'); ?>"><?php _e( 'Slide duration:' ,THEME_ADMIN_LANG ); ?></label>
				...
				<div class="zaccordion options" style="<?php if($Slider!='zaccordion'){ echo 'display:none'; }?>">
					<p>
					<label for="<?php echo $this->get_field_id('zAWidth'); ?>"><?php _e( 'Image Width in Slide:' ,THEME_ADMIN_LANG ); ?></label>
	      			<input type="text" value="<?php echo $zAWidth; ?>"  id="<?php echo $this->get_field_id('zAWidth'); ?>" name="<?php echo $this->get_field_name('zAWidth'); ?>" />
					</p>
	      			<p>
	      			<p>
					<label for="<?php echo $this->get_field_id('zAAuto'); ?>"><?php _e( 'Auto Slide :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('zAStyle'); ?>"><?php _e( 'Captions :' ,THEME_ADMIN_LANG ); ?></label>
					<select id="<?php echo $this->get_field_id('zAStyle'); ?>" name="<?php echo $this->get_field_name('zAStyle'); ?>" >
						<option value="0" <?php selected($zAStyle,'0'); ?> ><?php _e( 'No Captions ' ,THEME_ADMIN_LANG ); ?></option>
						<option value="1" <?php selected($zAStyle,'1'); ?> ><?php _e( 'Bottom Captions' ,THEME_ADMIN_LANG ); ?></option>
						<option value="2" <?php selected($zAStyle,'2'); ?> ><?php _e( 'Fancy Captions' ,THEME_ADMIN_LANG ); ?></option>
					</select>
					</p>
					<p>
					<label for="<?php echo $this->get_field_id('zABcolor'); ?>"><?php _e( 'Caption BG Color:' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('zAColor'); ?>"><?php _e( 'Caption Text Color:' ,THEME_ADMIN_LANG ); ?></label>
	      			<input type="text" value="<?php echo $zAColor; ?>"  id="<?php echo $this->get_field_id('zAColor'); ?>" name="<?php echo $this->get_field_name('zAColor'); ?>" />
					</p>
					<p>
					<label for="<?php echo $this->get_field_id('zAtimeout'); ?>"><?php _e( 'Delay Between Slides :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('zAspeed'); ?>"><?php _e( 'Animation Speed :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id('zAEasing'); ?>"><?php _e( 'Animation (easing) :' ,THEME_ADMIN_LANG ); ?></label>
				...
				<h3>Slide Deck Options: </h3>
					<label for="<?php echo $this->get_field_id('SDWidth'); ?>"><?php _e( 'Image Width in Slide :' ,THEME_ADMIN_LANG ); ?></label>
					<input type="text" value="<?php echo $SDWidth; ?>"  id="<?php echo $this->get_field_id('SDWidth'); ?>" name="<?php echo $this->get_field_name('SDWidth'); ?>" />
	      			<label for="<?php echo $this->get_field_id('SDHeight'); ?>"><?php _e( 'Image Height in Slide :' ,THEME_ADMIN_LANG ); ?></label>
	      			...
	      			<p>
					<label for="<?php echo $this->get_field_id('SDSpines'); ?>"><?php _e( 'Spines :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('SDAuto'); ?>"><?php _e( 'Auto Slide :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('SDIndex'); ?>"><?php _e( 'Show Index Number :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('SDVideo'); ?>"><?php _e( 'Show Video Instead of Image :' ,THEME_ADMIN_LANG ); ?></label>
					...
					<p>
					<label for="<?php echo $this->get_field_id('SDInterval'); ?>"><?php _e( 'Slide Speed :' ,THEME_ADMIN_LANG ); ?></label>
