...
if($instance["nivo_color"]!='grey'){
	$nivocolor = 'nivo'.$instance["nivo_color"];
}
?>

<div class="slider-wrapper <?php echo $nivocolor; ?>">
	<div id="<?php echo $this->id.'-nivo'; ?>" class="nivoSlider" style="width:<?php echo $instance["Width"]?>px;height:<?php echo $instance["Height"]?>px" >
	<?php 
