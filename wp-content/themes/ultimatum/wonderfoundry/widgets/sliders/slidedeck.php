<?php
wp_enqueue_script('jquery-slidedeck',THEME_JS.'/slidedeck.jquery.lite.js');
wp_enqueue_script('jquery-mousewheel',THEME_JS.'/jquery.mousewheel.min.js');
...
<h3 class="slidertitle"><?php echo $image[title]; ?></h2>
<?php } ?>
