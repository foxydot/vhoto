...
<?php
	...
	<div class="widget-control-actions">
		...
		<a class="thickbox button-primary autowidth" href="<?php echo THEME_ADMIN_URI; ?>/interfaces/wonder-layout/css-generator.php?layoutid=<?php echo $_GET[layoutid];?>&container=<?php echo esc_attr($id_format); ?>&modal=true&TB_iframe=1&width=640&height=380">Widget CSS</a>
		</div>
		<br class="clear" />
	</div>
	</form>
