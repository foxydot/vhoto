...
if ( ! function_exists('form_input'))
{
	...
	{
		$defaults = array('type' => 'text', 'name' => (( ! is_array($data)) ? $data : ''), 'title' => (( ! is_array($data)) ? $data : ''), 'value' => $value);
...
{
	function form_checkbox($data = '', $value = '', $checked = FALSE, $extra = '', $required = FALSE)
	{
    ...
    $class = $required ? 'class="required"' : '';
		...
		return "<input "._parse_form_attributes($data, $defaults).$extra." $class />";
	}
}
