...
<head>
	...
	<script language="javascript" type="text/javascript" src="<?php echo get_template_directory_uri() ?>/wonderfoundry/admin/tinymce/tinymce.js"></script>
	<link rel="stylesheet" href="<?php echo THEME_ADMIN_URI; ?>/css/colorpicker.css" type="text/css" />
	<link rel="stylesheet" href="<?php echo THEME_ADMIN_URI; ?>/css/mce.css" type="text/css" />
...
<?php } ?>
    ...
    <script type="text/javascript" src="<?php echo THEME_ADMIN_URI; ?>/js/layoutmce.js"></script>
    <script type="text/javascript" src="<?php echo THEME_ADMIN_URI; ?>/js/jquery.table.addrow.js"></script>
	<base target="_self" />
</head>
<body>
<?php 
include ('funcs.php');
$uri = THEME_ADMIN_URI.'/tinymce/codeinsert.php';
...
$folder = THEME_DIR.'/images/icons/48/';
$folderi = THEME_DIR.'/images/icons/';
if ($handle = opendir($folder)) {
	while (false !== ($entry = readdir($handle))) {
		if ($entry != "." && $entry != ".." && eregi(".png", $entry)) {
