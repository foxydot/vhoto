...
class ezTweet {
	...
	private function getTwitterJSON() {
		...
		if(get_theme_option('general', 'tw_consumer_key') && get_theme_option('general', 'tw_consumer_secret') && get_theme_option('general', 'tw_access_token') && get_theme_option('general', 'tw_access_secret')){
			$tmhOAuth = new tmhOAuth(array(
				'host'                  => $_POST['request']['host'],
				'consumer_key'          => get_theme_option('general', 'tw_consumer_key'),
				'consumer_secret'       => get_theme_option('general', 'tw_consumer_secret'),
				'user_token'            => get_theme_option('general', 'tw_access_token'),
				'user_secret'           => get_theme_option('general', 'tw_access_secret'),
