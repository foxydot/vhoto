...
/**
 * Replace default copy in sidebars
 */
remove_action( 'genesis_sidebar', 'genesis_do_sidebar' );
add_action( 'genesis_sidebar', 'empty_child_do_sidebar' );
/**
 * Echo primary sidebar default content.
 *
 * @since 1.2.0
*/
function empty_child_do_sidebar() {
...
add_action( 'genesis_sidebar_alt', 'empty_child_sidebar_alt' );
/**
 * Echo alternate sidebar default content.
 *
 * @since 1.2.0
*/
function empty_child_do_sidebar_alt() {
