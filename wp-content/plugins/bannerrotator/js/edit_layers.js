var UniteLayersBanner = new function() {
	...
	t.insertButton = function(buttonClass,buttonText){
		...
		var html = "<a href='javascript:alert(\"click\");' class='banner-rotator-button "+buttonClass+" small'>"+buttonText+"</a>";
				...
				var buttons = {							
					...
					"Update":function() {					
						...
						UniteAdminBanner.ajaxRequest("update_captions_css",data,function(response){
							...
							if(urlCssCaptions)
								UniteAdminBanner.loadCssFile(urlCssCaptions,"banner-rotator-captions-css");
