...
rhl_jQuery(document).ready(function($){	
	...
	//--
	$('#rh-modal-login').on('shown',function(){
		fill_default_values();
	});
	//$('#rh-modal-login').trigger('shown');
	
	$('#btn-reset-css').live('click',function(){
	...
	$('.real-time').live('change',function(e){
	...
	//--
	$('.uploaded_image_url_thumb').live('click',function(e){					
	...
	$('.alternate-color-values').live('change',function(e){
	...
	$('.rhl-backup-item a').live('click',function(e){
		css_restore(this);
	});
	
	$('#btn-restore-backup').live('click',function(e){
		css_restore();
	});
});
