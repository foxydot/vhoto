...
//		return str_replace('/wp-admin','/myadmin',$url);
//	}
	...
	function init(){
		...
		//wp_enqueue_style( 'rh-modal-login', RHL_URL.'css/style.less', array(),'1.0.0');
		wp_enqueue_style( 'rh-modal-login', RHL_URL.'css/styles.css', array(),'1.0.1.2');

		//wp_enqueue_script( 'less', RHL_URL.'js/less-1.3.0.min.js', array(),'1.3.0');
/*
		if( is_admin() ){
			if('1'!=$this->get_option('disable_bootstrap_admin','0',true)){
				wp_enqueue_script( 'sws-bootstrap', RHL_URL.'bootstrap/js/bootstrap.min.js', array(),'2.0.4');
			}
		}else{
			if('1'!=$this->get_option('disable_bootstrap','0',true)){
				wp_enqueue_script( 'sws-bootstrap', RHL_URL.'bootstrap/js/bootstrap.min.js', array(),'2.0.4');
			}
		}
*/
		rh_enqueue_script( 'bootstrap', RHL_URL.'bootstrap/js/bootstrap.js', array(),'2.2.1');
		wp_register_script( 'rhl-jquery', RHL_URL.'js/jquery-1.8.3.min.js', array(),'1.8.3');

		wp_enqueue_script( 'rhl-scripts', RHL_URL.'js/scripts.js', array(),'1.0.0');
		if(is_admin()):
