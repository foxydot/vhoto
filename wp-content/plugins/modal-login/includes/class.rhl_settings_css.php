				...
				<div class="rhl-inp-showon">
					...
					<div class="rhl-inp-showon-options">
						...
						<div class="rhl-inp-showon-options-item">
							<input class="chk_showon" type="checkbox" <?php echo in_array($value,$c->showon)?'checked="checked"':''?> name="custom_links[<?php echo $c->id?>][showon][]" value="<?php echo $value?>"/> <?php echo $label ?>
						</div>
						<?php endforeach; ?>
					</div>
				</div>
